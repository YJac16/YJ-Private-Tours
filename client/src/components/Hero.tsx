    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
        <div className="relative mx-auto mb-4 sm:mb-5 w-fit max-w-[min(92vw,28rem)]">
          {/* Soft vignette only — keeps logo readable on bright sky/rock without a card */}
          <div
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-stretch sm:justify-center items-stretch sm:items-center max-w-md sm:max-w-none mx-auto">
          ...
          <Link
            to="/book"
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:py-3 min-h-12 bg-brand-green hover:bg-brand-green-dark text-brand-cream font-semibold rounded-xl transition-all shadow-lg shadow-black/25 active:scale-[0.98] w-full sm:w-auto sm:min-w-50 border-2 border-white/20"
          >
